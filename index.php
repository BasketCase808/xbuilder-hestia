<?php
define('tututtoken-OMGOMGOMGIMSKINTSTIWWWWWTFFFFF-yo', true);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!-- Emmet -->
<script src="js/code-editor/emmet.js"></script>
<script src="js/code-editor/ace/ace.js"></script>
<script src="js/code-editor/ace/ext-emmet.js"></script>
...
<script type="application/javascript">
    ...
    scriptTag.setAttribute("src", "js/builder.min.js" + id);
    styleTag.setAttribute("href", "css/style.css" + id);
